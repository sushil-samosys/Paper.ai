...
import com.ogaclejapan.arclayout.ArcDrawable;
...
public class ArcLayout extends ViewGroup {
  ...
  protected void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    final TypedArray a = context.getTheme().obtainStyledAttributes(
        attrs, com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout, defStyleAttr, defStyleRes);
    int arcOrigin = a.getInt(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_origin, DEFAULT_ORIGIN);
    int arcColor = a.getColor(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_color, DEFAULT_COLOR);
    int arcRadius = a.getDimensionPixelSize(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_radius, DEFAULT_RADIUS);
    int arcAxisRadius = a.getDimensionPixelSize(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_axisRadius, DEFAULT_AXIS_RADIUS);
    boolean isArcFreeAngle = a.getBoolean(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_freeAngle, DEFAULT_FREE_ANGLE);
    boolean isArcReverseAngle = a.getBoolean(
        com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_arc_reverseAngle, DEFAULT_REVERSE_ANGLE);
    a.recycle();
  ...
  public static class LayoutParams extends MarginLayoutParams {
    ...
    public LayoutParams(Context c, AttributeSet attrs) {
      ...
      TypedArray a = c.getTheme()
          .obtainStyledAttributes(attrs, com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_Layout, 0, 0);
      origin = a.getInt(com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_Layout_arc_origin, DEFAULT_CHILD_ORIGIN);
      angle = a.getFloat(com.ogaclejapan.arclayout.R.styleable.arc_ArcLayout_Layout_arc_angle, DEFAULT_CHILD_ANGLE);
      a.recycle();
    }
