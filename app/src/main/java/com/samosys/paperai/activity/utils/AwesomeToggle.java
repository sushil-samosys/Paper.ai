...
/**
 * Created by samosys on 1/2/18.
 */

public class AwesomeToggle  extends RelativeLayout implements View.OnClickListener {
    ...
    public AwesomeToggle(Context context, AttributeSet attrs) {
        ...
        _sp = context.getSharedPreferences("demo", Context.MODE_PRIVATE);
